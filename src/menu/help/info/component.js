...
import styles from '@/menu/help/info/styles';
...
export default function Information() {
  ...
  return (
    <div className="main-container">
      ...
      <hr />
      <p>
        <a href="#administrators">1. Administrators</a>
        <br />
        <a href="#register">2. Register</a>
        <br />
        <a href="#system">3. System</a>
        <br />
        <a href="#competitions">4. Competitions</a>
        <br />
        <a href="#rules">5. Rules</a>
        <br />
        <a href="#calendar">6. Calendar</a>
        <br />
        <a href="#prizes">7. Prizes</a>
      </p>
      <ScrollableAnchor id="administrators">
        <div>
          <h2 className="heading2">1. Administrators</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="register">
        <div>
          <h2 className="heading2">2. Register</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="system">
        <div>
          <h2 className="heading2">3. System</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="competitions">
        <div>
          <h2 className="heading2">4. Competitions</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="rules">
        <div>
          <h2 className="heading2">5. Rules</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="calendar">
        <div>
          <h2 className="heading2">6. Calendar</h2>
          <hr />
          <p>
      ...
      <ScrollableAnchor id="prizes">
        <div>
          <h2 className="heading2">7. Prizes</h2>
          <hr />
          <p>
