...
import SameTeam from '@/menu/games/game/players/players/player/same-team/component';
import styles, { muiStyles } from '@/menu/games/game/players/players/player/styles';
