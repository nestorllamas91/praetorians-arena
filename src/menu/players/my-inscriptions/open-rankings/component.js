...
import OpenRankingsTables from '@/menu/players/my-inscriptions/open-rankings/open-rankings-tables/component';
import OpenRanking from '@/menu/players/my-inscriptions/open-rankings/open-rankings-tables/open-ranking/component';
import styles from '@/menu/players/my-inscriptions/open-rankings/styles';
...
export default function OpenRakings() {
  ...
  async function getOpenRankings() {
    try {
      const url = '/api/account/my-inscriptions/open-rankings';
