...
import styles, {
  stylesGlobal,
  stylesMaterialUI
} from '@/menu/players/my-inscriptions/open-rankings/open-rankings-tables/open-ranking/team-inscription/styles';
...
function TeamInscription(props) {
  ...
  async function handleSendTeamProposal() {
    MySwal.fire({
      ...
      if (result.value) {
        try {
          const url = `/api/account/my-inscriptions/send-proposal/${ranking.rankingID}/${
