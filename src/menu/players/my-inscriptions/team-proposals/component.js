...
import styles from '@/menu/players/my-inscriptions/team-proposals/styles';
import TeamProposal from '@/menu/players/my-inscriptions/team-proposals/team-proposal/component';
import Row from '@/menu/players/my-inscriptions/team-proposals/team-proposal/row/component';
...
export default function TeamProposals(props) {
  ...
  async function getTeamProposals() {
    try {
      const url = `/api/account/my-inscriptions/team-proposals/${player.data.steamId}`;
