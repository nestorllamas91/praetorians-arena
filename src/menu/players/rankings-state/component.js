...
import Rankings from '@/menu/players/rankings-state/rankings/component';
import Ranking from '@/menu/players/rankings-state/rankings/ranking/component';
import styles from '@/menu/players/rankings-state/styles';
...
export default function RankingsState() {
  ...
  async function getRankings() {
    try {
      const url = '/api/account/rankings-state/rankings';
