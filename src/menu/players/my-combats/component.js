...
import Combat from '@/menu/players/my-combats/combat/component';
import styles from '@/menu/players/my-combats/styles';
...
export default function MyCombats() {
  ...
  async function getCombats() {
    try {
      const url = `/api/account/my-combats/combats/${player.data.steamId}`;
