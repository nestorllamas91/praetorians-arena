...
import { logInPlayer, logOutPlayer } from '@/menu/players/auth/slice';
import MenuAccount1 from '@/shared/navigation-bar/menu-account-1/component';
import MenuAccount2 from '@/shared/navigation-bar/menu-account-2/component';
import Page from '@/shared/navigation-bar/page/component';
import styles, { stylesMaterialUI } from '@/shared/navigation-bar/styles';
...
function NavigationBar(props) {
  ...
  async function getSeasons() {
    try {
      const url = '/api/competitions/seasons';
  ...
  function handleLogout() {
    ...
    const token = cookies.get('player_session');
    dispatch(logOutPlayer(token));
  }
        ...
        <AppBar position="static" classes={{ root: classes.appbar }}>
          <Toolbar classes={{ root: classes.toolbar }}>
            <a onClick={handleClickHome} className="logo-container">
              <img src="/assets/images/logos/praetorians-arena.png" className="logo" />
            </a>
            ...
            <div>
              {!player.isAuthenticated ? (
                <img src="/assets/images/misc/steam.png" onClick={handleClickLogin} className="button-login" />
              ) : (
                <Fragment>
                  <IconButton
                    disableRipple={true}
