...
import styles from '@/components/competitions/styles';
...
import Ranking from '@/components/competitions/ranking/component';
import Row from '@/components/competitions/ranking/row/component';
import NameRanking from '@/components/competitions/name-ranking/component';
          ...
          <div className="selector-competition">
            {currentCompetitions.length === 0 ? (
              ...
              currentCompetitions.map(myCompetition => {
                ...
                return (
                  <div key={uuidv4()} className={`selector ${Number(rankingId) === myCompetition.rankingID ? 'active-page' : ''}`}>
          ...
          <div className="main-container rankings-container">
            <div className="ranking">
              {ranking === null ? (
                ...
                <Fragment>
                  <NameRanking season={ranking.season} competition={ranking.competition} fontSize="big" alignment="center" />
                  <hr />
                ...
                <Fragment>
                  ...
                  <div className="ranking-table">
                    ...
                    <Ranking numPlayersPerGame={ranking.numPlayersPerGame} viewData={user === 'true' ? 'ranking1' : 'ranking2'}>
                      {ranking.data.map(row => {
                        if (row.enrollmentState === 'accepted') {
                          return <Row key={uuidv4()} ranking={ranking} row={row} viewData={user === 'true' ? 'ranking1' : 'ranking2'} />;
                        }
                      })}
                    </Ranking>
                  </div>
