...
import styles, { stylesMaterialUI, stylesSyncfusion } from '@/components/account/my-combats/my-combat/styles';
import { withStyles } from '@mui/styles';

import axios from 'axios';
import { dateLocalToUtc, dateUtcToLocal } from '@/utils/functions';
import { fixRankingSelectors } from '@/utils/functions';
import maps from '../../../../../public/assets/data/maps.json';
