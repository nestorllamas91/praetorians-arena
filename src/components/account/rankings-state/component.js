...
import styles from '@/components/account/rankings-state/styles';

import axios from 'axios';
import { v4 as uuidv4 } from 'uuid';

import Rankings from '@/components/account/rankings-state/rankings/component';
import Ranking from '@/components/account/rankings-state/rankings/ranking/component';
