...
import styles, { stylesMaterialUI } from '@/components/account/my-inscriptions/team-proposals/team-proposal/row/styles';
import { withStyles } from '@mui/styles';

import { fixRankingSelectors } from '@/utils/functions';
import Router from 'next/router';

import Buttons from '@/components/account/my-inscriptions/team-proposals/team-proposal/row/buttons/component';
