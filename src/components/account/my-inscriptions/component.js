...
import styles from '@/components/account/my-inscriptions/styles';

import { v4 as uuidv4 } from 'uuid';

import OpenRankings from '@/components/account/my-inscriptions/open-rankings/component';
import TeamProposals from '@/components/account/my-inscriptions/team-proposals/component';
