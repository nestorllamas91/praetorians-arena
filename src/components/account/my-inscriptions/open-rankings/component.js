...
import styles from '@/components/account/my-inscriptions/open-rankings/styles';

import axios from 'axios';
import { v4 as uuidv4 } from 'uuid';

import OpenRanking from '@/components/account/my-inscriptions/open-rankings/open-rankings-tables/open-ranking/component';
import OpenRankingsTables from '@/components/account/my-inscriptions/open-rankings/open-rankings-tables/component';
