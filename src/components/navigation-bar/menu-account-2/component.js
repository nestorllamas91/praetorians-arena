...
import styles from '@/components/navigation-bar/menu-account-2/styles';

import Divider from '@mui/material/Divider';
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';

export default function MenuAccount2(props) {
  return (
    <Fragment>
      <Menu
      ...
      >
        ...
        <Divider />
        <MenuItem onClick={props.handleRankingsState}>Rankings State</MenuItem>
        <Divider />
