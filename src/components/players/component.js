...
import styles, { stylesMaterialUI } from '@/components/players/styles';
import { withStyles } from '@mui/styles';

import axios from 'axios';
import countriesSteam from '../../../public/assets/data/countries-steam.json';
                    ...
                    <TableRow key={uuidv4()} classes={{ root: classes.tableBodyRow }}>
                      ...
                      <TableCell align="center" padding="none" classes={{ root: classes.tableBodyCell }}>
                        {player.steamCountry === undefined ? (
                          ...
                          Object.keys(countriesSteam).map(country =>
                            country === player.steamCountry ? countriesSteam[country].name : undefined
                          )
                        )}
                      </TableCell>
                      <TableCell align="center" padding="none" classes={{ root: classes.tableBodyCell }}>
