import styles from '@/components/privacy-policy/styles';
  ...
  return (
    <div className="main-container">
      <p>
        ...
        service of an online competition platform for the videogame Praetorians Remaster. This page informs you of our
